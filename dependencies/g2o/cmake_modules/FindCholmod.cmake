...
find_library(CHOLMOD_LIBRARY cholmod PATHS $ENV{CHOLMODDIR})
...
if(CHOLMOD_LIBRARIES)
  ...
  find_library(CHOLMOD_METIS_LIBRARY metis PATHS ${CHOLMOD_LIBDIR} $ENV{CHOLMODDIR})
...
if(CHOLMOD_LIBRARIES)
  find_library(SUITESPARSECONFIG_LIBRARY NAMES suitesparseconfig
    PATHS ${CHOLMOD_LIBDIR} $ENV{CHOLMODDIR})
