...
public:
    ...
    Frame(cv::Mat &im, const double &timeStamp, cv::FastFeatureDetector* detector, cv::BriefDescriptorExtractor* extractor, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef);
    //Frame(cv::Mat &im, const double &timeStamp, cv::ORB* extractor, double scaleFactor, int nlevels, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef);
    ...
    double mfGridElementWidthInv;
    double mfGridElementHeightInv;
    ...
    bool isInFrustum(MapPoint* pMP, double viewingCosLimit);
