...
vector<KeyFrame*> KeyFrameDatabase::DetectLoopCandidates(KeyFrame* pKF, double minScore)
{
    ...
    list<pair<double,KeyFrame*> > lScoreAndMatch;
    ...
    list<pair<double,KeyFrame*> > lAccScoreAndMatch;
    double bestAccScore = minScore;

    // Lets now accumulate score by covisibility
    for(list<pair<double,KeyFrame*> >::iterator it=lScoreAndMatch.begin(), itend=lScoreAndMatch.end(); it!=itend; it++)
    {
    ...
    for(list<pair<double,KeyFrame*> >::iterator it=lAccScoreAndMatch.begin(), itend=lAccScoreAndMatch.end(); it!=itend; it++)
    {
